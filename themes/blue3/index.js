    ...
    <ThemeGlobalNav.Provider
      ...
      <div
        ...
        <main
          ...
          <div
            className={
              ' hidden md:block dark:border-transparent relative z-10 mx-4 w-[210px] max-h-full pb-44'
            }>
            {/* 图标Logo + 菜单 固定区域 */}
            ...
            <div className='main-menu z-20 pl-4 pr-6 pb-5 pt-1 overflow-y-scroll h-fit max-h-screen scroll-hidden bg-white dark:bg-neutral-800 rounded-xl '>
              {/* 嵌入 */}
              {slotLeft}
